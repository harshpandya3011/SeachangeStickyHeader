...
open class StickyHeaderItemDecoration(
        ...
        private val mListener: HeaderEventListener
        ...
        parent.addOnItemTouchListener(object : RecyclerView.SimpleOnItemTouchListener() {
            override fun onInterceptTouchEvent(
                ...
                return if (motionEvent.action == MotionEvent.ACTION_DOWN) {
                    if (motionEvent.y <= currentHeader?.second?.itemView?.bottom!!) {
                        ...
                        val headerView = getHeaderViewForItem(topChildPosition, parent)
                                ?: return false
                        mListener.onHeaderClicked(headerView, getHeaderPositionForItem(topChildPosition))
    ...
    interface HeaderEventListener {
        fun onHeaderClicked(view: View, headerPosition: Int)
    }
}

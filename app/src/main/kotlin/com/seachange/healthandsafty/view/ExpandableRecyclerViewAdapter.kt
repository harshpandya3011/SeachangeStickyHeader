 ...
 */
(
        var mExpandableList: ArrayList<ExpandableType>,
        val expandingDirection: ExpandingDirection
    ...
    private fun setupChildRecyclerView(holder: PVH, position: Int) {
        ...
        onBindParentViewHolder(holder, expandableGroup, position, childListAdapter)
    }
    ...
    inner class ChildListAdapter(
        ...
        override fun onBindViewHolder(holder: CVH, position: Int) {
            ...
            onBindChildViewHolder(holder, expanded, expandableGroup, position, parentPosition)
        }
    ...
    fun updateList(it: java.util.ArrayList<ExpandableType>) {
        mExpandableList = it
        notifyDataSetChanged()
    }

    fun updateListItem(expandableType: ExpandableType, parentPosition: Int) {
        mExpandableList[parentPosition] = expandableType

...
class CheckListTypeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (requireActivity() as AppCompatActivity).apply {
            ...
            supportActionBar?.title = "Checklist Type"
        }

        checkListTemplateViewModel.fetchCheckTypeList()
        checkListTemplateViewModel.checkListTypeLiveData.observe(this, Observer {
    ...
    private fun attachAdapter() {
        ...
        checkListTypeList = checkListTemplateViewModel.checkListTypeLiveData.value!!

package com.seachange.healthandsafty.qrcode;
...
public class ScannerOverlay extends ViewGroup {
    ...
    private int frames;
    private boolean revAnimation, onPause;
    ...
    public ScannerOverlay(Context context, AttributeSet attrs, int defStyle) {
        ...
        lineColor = a.getColor(R.styleable.ScannerOverlay_line_color, ContextCompat.getColor(context, R.color.colorDefaultGreen));

...
import com.seachange.healthandsafty.fragment.IrregularScheduleTimeFragment
...
class IrregularScheduleTimeRecyclerViewAdapter(
        private val mValues: List<ZoneCheckTimeRange>,
        private val mCtx: Context,
        private val day:Int,
        private val mListener: IrregularScheduleTimeFragment.OnSwipeClickListener? )
    : RecyclerView.Adapter<IrregularScheduleTimeRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (item.isEndTimeIsNextDay) {
            timeString =  timeString + "(" + DateUtil().getDaySubString(day) + ")"
        }
